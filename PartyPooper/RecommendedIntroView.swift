...
class RecommendedIntroView: UIView{
    ...
    let textLabel: UITextView = {
        ...
        view.text = "It looks like you haven't filled out your stances yet!"
    ...
    let fillStancesButton: UIButton = {
        ...
        view.setTitle("Fill Stances", for: .normal)
    ...
    func setupViews(){
        ...
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-30-[v0(100)]-10-[v1(60)]", options: NSLayoutFormatOptions(), metrics: nil, views: views))
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:[v1(200)]", options: NSLayoutFormatOptions(), metrics: nil, views: views))
